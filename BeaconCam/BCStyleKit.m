...
static UIColor* _baseButtonColor = nil;
static UIColor* _disabledColor = nil;
static UIColor* _enabledColor = nil;
...
+ (void)initialize
{
    ...
    _baseButtonColor = [UIColor colorWithRed: 0.636 green: 0.589 blue: 0.701 alpha: 1];
    CGFloat baseButtonColorRGBA[4];
    [_baseButtonColor getRed: &baseButtonColorRGBA[0] green: &baseButtonColorRGBA[1] blue: &baseButtonColorRGBA[2] alpha: &baseButtonColorRGBA[3]];

    _disabledColor = [UIColor colorWithRed: (baseButtonColorRGBA[0] * 0.4 + 0.6) green: (baseButtonColorRGBA[1] * 0.4 + 0.6) blue: (baseButtonColorRGBA[2] * 0.4 + 0.6) alpha: (baseButtonColorRGBA[3] * 0.4 + 0.6)];
    _enabledColor = [BCStyleKit.baseButtonColor colorWithAlphaComponent: 0.5];

}

#pragma mark Colors

+ (UIColor*)baseButtonColor { return _baseButtonColor; }
+ (UIColor*)disabledColor { return _disabledColor; }
+ (UIColor*)enabledColor { return _enabledColor; }
...
+ (void)drawGenericButtonWithText: (NSString*)text highlighted: (BOOL)highlighted;
{
    ...
    [BCStyleKit.disabledColor setFill];
    [rectanglePath fill];
    [BCStyleKit.baseButtonColor setStroke];
    ...
    if (highlighted)
    {
        ...
        [BCStyleKit.enabledColor setFill];
        [rectangle2Path fill];
        [BCStyleKit.enabledColor setStroke];
